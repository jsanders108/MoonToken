...
export default function KeyStats(){
    ...
    const contractAddress = "0x87AbaAD3F371650E012bbeA2BB4396Ff1E9914Ed"
    ...
    let [displayAddress, setDisplayAddress] = useState("")
    ...
    return (
        <div>
            ...
            <div className="keystats-wrapper">
                <h2 className="main--title">Key Statistics</h2>
                <p>Name: {name} </p>
                <p>Symbol: {symbol} </p>
                <p>Decimals: {decimals} </p>
                <p>Total Supply: {totalSupply}</p>
                <p>Contract Address: {displayAddress}</p>
                <button onClick={getData} className="keystats-btn">Get Stats</button>
            </div> 
        </div> 
    )
}
